...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "chunkIter.autotvin.dat"
	set constFileTvOut       "chunkIter.autotvout.dat"
	set constFileHdlTvIn     "chunkIter.autohdltvin.dat"
	set constFileHdlTvOut    "chunkIter.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
