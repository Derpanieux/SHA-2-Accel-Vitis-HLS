...
if {[file isfile chunkIter.autotvin.dat]} {
	file delete -force chunkIter.autotvin.dat
}

if {[file isfile chunkIter.autotvout.dat]} {
	file delete -force chunkIter.autotvout.dat
}
