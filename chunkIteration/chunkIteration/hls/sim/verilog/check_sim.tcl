...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.chunkIter.autotvin_kt.dat"
         "c.chunkIter.autotvin_wt.dat"
         "c.chunkIter.autotvin_wvarsin.dat"
         "c.chunkIter.autotvin_wvarsout.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.chunkIter.autotvout_wvarsout.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
