...
#define AUTOTB_TVOUT_kt "../tv/cdatafile/c.chunkIter.autotvout_kt.dat"
#define AUTOTB_TVIN_wt "../tv/cdatafile/c.chunkIter.autotvin_wt.dat"
#define AUTOTB_TVOUT_wt "../tv/cdatafile/c.chunkIter.autotvout_wt.dat"
#define AUTOTB_TVIN_wvarsin "../tv/cdatafile/c.chunkIter.autotvin_wvarsin.dat"
#define AUTOTB_TVOUT_wvarsin "../tv/cdatafile/c.chunkIter.autotvout_wvarsin.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_wvarsout "../tv/rtldatafile/rtl.chunkIter.autotvout_wvarsout.dat"
...
extern "C"
void chunkIter_hw_stub_wrapper(hls::sim::Byte<4>*, hls::sim::Byte<4>*, void*, void*);

extern "C"
void apatb_chunkIter_hw(hls::sim::Byte<4>* __xlx_apatb_param_kt, hls::sim::Byte<4>* __xlx_apatb_param_wt, void* __xlx_apatb_param_wvarsin, void* __xlx_apatb_param_wvarsout)
{
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_kt),
#endif
  };
  port0.param = __xlx_apatb_param_kt;
  ...
  port1.param = __xlx_apatb_param_wt;
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port2 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_wvarsin),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_wvarsin),
#endif
#endif
    .hasWrite = { false },
    .max_nbytes = { 0 },
  };
  port2.param = { __xlx_apatb_param_wvarsin };
  port2.mname = { "wvarsin" };
  port2.nbytes = { 32 };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_wvarsout),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_wvarsout),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_wvarsout),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_wvarsout),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_wvarsout),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_wvarsout),
#endif
#endif
    .hasWrite = { true },
    .max_nbytes = { 0 },
  };
  port3.param = { __xlx_apatb_param_wvarsout };
  port3.mname = { "wvarsout" };
  port3.nbytes = { 32 };
  ...
  try {
    ...
    chunkIter_hw_stub_wrapper(__xlx_apatb_param_kt, __xlx_apatb_param_wt, __xlx_apatb_param_wvarsin, __xlx_apatb_param_wvarsout);
