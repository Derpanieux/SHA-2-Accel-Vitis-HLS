...
HLS_SOURCES = ../../../../tb.cpp ../../../../../functions256.cpp ../../../../chunkIter.cpp
...
$(ObjDir)/chunkIter.o: ../../../../chunkIter.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../chunkIter.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \
