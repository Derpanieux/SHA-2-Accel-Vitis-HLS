...
set C_modelArgMapList {[ 
	{ "Name" : "bitstream", "interface" : "fifo", "bitwidth" : 1, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "output_r", "interface" : "wire", "bitwidth" : 512, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ output_r sc_out sc_lv 512 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "output_r", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "output_r", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	output_r { ap_vld {  { output_r out_data 1 512 }  { output_r_ap_vld out_vld 1 1 } } }
}
