...
if {[file isfile sha512Accel.autotvin.dat]} {
	file delete -force sha512Accel.autotvin.dat
}

if {[file isfile sha512Accel.autotvout.dat]} {
	file delete -force sha512Accel.autotvout.dat
}
