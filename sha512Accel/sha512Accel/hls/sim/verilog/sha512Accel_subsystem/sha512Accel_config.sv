...
//
//==============================================================
`ifndef SHA512ACCEL_CONFIG__SV                        
    `define SHA512ACCEL_CONFIG__SV                    
                                                            
    class sha512Accel_config extends uvm_object;            
        ...
        `uvm_object_utils_begin(sha512Accel_config)         
        ...
        function new (string name = "sha512Accel_config");
            super.new(name);                                
