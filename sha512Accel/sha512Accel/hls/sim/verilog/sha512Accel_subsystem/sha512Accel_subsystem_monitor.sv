...
`ifndef SHA512ACCEL_SUBSYSTEM_MONITOR_SV
`define SHA512ACCEL_SUBSYSTEM_MONITOR_SV
...
class sha512Accel_subsystem_monitor extends uvm_component;

    sha512Accel_reference_model refm;
    sha512Accel_scoreboard scbd;

    `uvm_component_utils_begin(sha512Accel_subsystem_monitor)
    `uvm_component_utils_end

    uvm_analysis_imp_svr_master_bitstream#(svr_pkg::svr_transfer#(1), sha512Accel_subsystem_monitor) svr_master_bitstream_imp;
    uvm_analysis_imp_svr_master_size#(svr_pkg::svr_transfer#(128), sha512Accel_subsystem_monitor) svr_master_size_imp;
    uvm_analysis_imp_svr_slave_output_r#(svr_pkg::svr_transfer#(512), sha512Accel_subsystem_monitor) svr_slave_output_r_imp;
    ...
    virtual function void build_phase(uvm_phase phase);
        ...
        scbd = sha512Accel_scoreboard::type_id::create("scbd", this);
    endfunction
