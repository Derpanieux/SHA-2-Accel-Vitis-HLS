...
`ifndef SHA512ACCEL_REFERENCE_MODEL_SV
`define SHA512ACCEL_REFERENCE_MODEL_SV

class sha512Accel_reference_model extends uvm_component;
    ...
    `uvm_component_utils_begin(sha512Accel_reference_model)
