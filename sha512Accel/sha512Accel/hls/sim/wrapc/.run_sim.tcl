...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "sha512Accel.autotvin.dat"
	set constFileTvOut       "sha512Accel.autotvout.dat"
	set constFileHdlTvIn     "sha512Accel.autohdltvin.dat"
	set constFileHdlTvOut    "sha512Accel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
