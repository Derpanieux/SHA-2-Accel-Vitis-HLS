; ModuleID = 'D:/Vitis/shaAccel/sha512Accel/sha512Accel/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_sha512Accel_ir(%"class.hls::stream<bool, 0>"* noalias nocapture nonnull dereferenceable(1) %bitstream, %"struct.ap_uint<128>"* nocapture readonly %size, %"struct.ap_uint<512>"* noalias nocapture nonnull %output) local_unnamed_addr #1 {
entry:
  ...
  call fastcc void @copy_in(%"class.hls::stream<bool, 0>"* nonnull %bitstream, i1* nonnull align 512 %bitstream_copy, %"struct.ap_uint<512>"* nonnull %output, i512* nonnull align 512 %output_copy)
  call void @apatb_sha512Accel_hw(i1* %bitstream_copy, %"struct.ap_uint<128>"* %size, i512* %output_copy)
  call void @copy_back(%"class.hls::stream<bool, 0>"* %bitstream, i1* %bitstream_copy, %"struct.ap_uint<512>"* %output, i512* %output_copy)
  ret void
}

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_in(%"class.hls::stream<bool, 0>"* noalias "unpacked"="0", i1* noalias nocapture align 512 "unpacked"="1.0", %"struct.ap_uint<512>"* noalias readonly "unpacked"="2", i512* noalias nocapture align 512 "unpacked"="3.0") unnamed_addr #2 {
entry:
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_out(%"class.hls::stream<bool, 0>"* noalias "unpacked"="0", i1* noalias nocapture align 512 "unpacked"="1.0", %"struct.ap_uint<512>"* noalias "unpacked"="2", i512* noalias nocapture readonly align 512 "unpacked"="3.0") unnamed_addr #6 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<bool, 0>"(%"class.hls::stream<bool, 0>"* %0, i1* align 512 %1)
  call fastcc void @"onebyonecpy_hls.p0struct.ap_uint<512>.29"(%"struct.ap_uint<512>"* %2, i512* align 512 %3)
  ret void
}

; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0struct.ap_uint<512>.29"(%"struct.ap_uint<512>"* noalias "unpacked"="0" %dst, i512* noalias nocapture readonly align 512 "unpacked"="1.0" %src) unnamed_addr #5 {
entry:
...
declare void @apatb_sha512Accel_hw(i1*, %"struct.ap_uint<128>"*, i512*)

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_back(%"class.hls::stream<bool, 0>"* noalias "unpacked"="0", i1* noalias nocapture align 512 "unpacked"="1.0", %"struct.ap_uint<512>"* noalias "unpacked"="2", i512* noalias nocapture readonly align 512 "unpacked"="3.0") unnamed_addr #6 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<bool, 0>"(%"class.hls::stream<bool, 0>"* %0, i1* align 512 %1)
  call fastcc void @"onebyonecpy_hls.p0struct.ap_uint<512>.29"(%"struct.ap_uint<512>"* %2, i512* align 512 %3)
  ret void
...
declare void @sha512Accel_hw_stub(%"class.hls::stream<bool, 0>"* noalias nocapture nonnull, %"struct.ap_uint<128>"* nocapture readonly, %"struct.ap_uint<512>"* noalias nocapture nonnull)

define void @sha512Accel_hw_stub_wrapper(i1*, %"struct.ap_uint<128>"*, i512*) #7 {
entry:
  %3 = call i8* @malloc(i64 1)
  %4 = bitcast i8* %3 to %"class.hls::stream<bool, 0>"*
  %5 = call i8* @malloc(i64 64)
  %6 = bitcast i8* %5 to %"struct.ap_uint<512>"*
  call void @copy_out(%"class.hls::stream<bool, 0>"* %4, i1* %0, %"struct.ap_uint<512>"* %6, i512* %2)
  call void @sha512Accel_hw_stub(%"class.hls::stream<bool, 0>"* %4, %"struct.ap_uint<128>"* %1, %"struct.ap_uint<512>"* %6)
  call void @copy_in(%"class.hls::stream<bool, 0>"* %4, i1* %0, %"struct.ap_uint<512>"* %6, i512* %2)
  call void @free(i8* %3)
  call void @free(i8* %5)
  ret void
}
