...
set ip_vlnv xilinx.com:hls:wGenerator:1.0
set ip_repo_path ../ip
...
dict set report_options hls_project wGenerator
...
dict set report_options topmodule "wGenerator"
dict set report_options funcmodules {wGenerator_wGenerator_Pipeline_VITIS_LOOP_9_1 wGenerator_wGenerator_Pipeline_VITIS_LOOP_12_2}
dict set report_options bindmodules wGenerator_flow_control_loop_pipe_sequential_init
