...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "wGenerator.autotvin.dat"
	set constFileTvOut       "wGenerator.autotvout.dat"
	set constFileHdlTvIn     "wGenerator.autohdltvin.dat"
	set constFileHdlTvOut    "wGenerator.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
