...
if {[file isfile wGenerator.autotvin.dat]} {
	file delete -force wGenerator.autotvin.dat
}

if {[file isfile wGenerator.autotvout.dat]} {
	file delete -force wGenerator.autotvout.dat
}
