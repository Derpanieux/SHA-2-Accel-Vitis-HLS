...
`ifndef WGENERATOR_REFERENCE_MODEL_SV
`define WGENERATOR_REFERENCE_MODEL_SV

class wGenerator_reference_model extends uvm_component;
    int trans_num_total = 10000;
    int trans_num_idx;
    int ap_done_cnt=1;
    ...
    `uvm_component_utils_begin(wGenerator_reference_model)
