...
#define AUTOTB_TVOUT_win "../tv/cdatafile/c.wGenerator.autotvout_win.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_wout "../tv/rtldatafile/rtl.wGenerator.autotvout_wout.dat"
...
extern "C"
void wGenerator_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_wGenerator_hw(void* __xlx_apatb_param_win, void* __xlx_apatb_param_wout)
{
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port0 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_win),
#else
  ...
  port0.param = { __xlx_apatb_param_win };
  port0.mname = { "win" };
  port0.nbytes = { 64 };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_wout),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_wout),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_wout),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_wout),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_wout),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_wout),
#endif
#endif
    .hasWrite = { true },
    .max_nbytes = { 0 },
  };
  port1.param = { __xlx_apatb_param_wout };
  port1.mname = { "wout" };
  port1.nbytes = { 256 };
  ...
  try {
    ...
    wGenerator_hw_stub_wrapper(__xlx_apatb_param_win, __xlx_apatb_param_wout);
