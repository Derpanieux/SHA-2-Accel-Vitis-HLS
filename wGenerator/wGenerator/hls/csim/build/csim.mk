...
HLS_SOURCES = ../../../../tb.cpp ../../../../wGenerator.cpp ../../../../../functions256.cpp
...
$(ObjDir)/wGenerator.o: ../../../../wGenerator.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../wGenerator.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
