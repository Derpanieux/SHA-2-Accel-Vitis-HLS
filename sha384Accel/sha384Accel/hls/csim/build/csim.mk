...
HLS_SOURCES = ../../../../tb.cpp ../../../../sha384Accel.cpp ../../../../../functions512.cpp ../../../../../wGenerator512/wGenerator512.cpp ../../../../../chunkProcessor512/chunkProcessor512.cpp ../../../../../chunkIteration512/chunkIter512.cpp
...
$(ObjDir)/sha384Accel.o: ../../../../sha384Accel.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../sha384Accel.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/sha384Accel.d
