...
// wrapc file define:
#define AUTOTB_TVIN_bitstream "../tv/cdatafile/c.sha384Accel.autotvin_bitstream.dat"
...
#define AUTOTB_TVIN_size "../tv/cdatafile/c.sha384Accel.autotvin_size.dat"
#define AUTOTB_TVOUT_size "../tv/cdatafile/c.sha384Accel.autotvout_size.dat"
#define AUTOTB_TVIN_output_r "../tv/cdatafile/c.sha384Accel.autotvin_output_r.dat"
#define AUTOTB_TVOUT_output_r "../tv/cdatafile/c.sha384Accel.autotvout_output_r.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_output_r "../tv/rtldatafile/rtl.sha384Accel.autotvout_output_r.dat"
...
extern "C"
void sha384Accel_hw_stub_wrapper(void*, hls::sim::Byte<16>*, void*);

extern "C"
void apatb_sha384Accel_hw(void* __xlx_apatb_param_bitstream, hls::sim::Byte<16>* __xlx_apatb_param_size, void* __xlx_apatb_param_output_r)
{
  static hls::sim::Stream<hls::sim::Byte<1>> port0 {
    .width = 1,
    .name = "bitstream",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_bitstream),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_bitstream),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_bitstream),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_bitstream),
#endif
  };
  port0.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_bitstream;
  ...
  try {
    ...
    sha384Accel_hw_stub_wrapper(__xlx_apatb_param_bitstream, __xlx_apatb_param_size, __xlx_apatb_param_output_r);
