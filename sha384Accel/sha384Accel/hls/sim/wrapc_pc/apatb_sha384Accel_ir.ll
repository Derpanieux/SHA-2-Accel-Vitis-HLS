; ModuleID = 'D:/Vitis/shaAccel/sha384Accel/sha384Accel/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_sha384Accel_ir(%"class.hls::stream<bool, 0>"* noalias nocapture nonnull dereferenceable(1) %bitstream, %"struct.ap_uint<128>"* nocapture readonly %size, %"struct.ap_uint<384>"* noalias nocapture nonnull %output) local_unnamed_addr #1 {
entry:
  %bitstream_copy = alloca i1, align 512
  call void @llvm.sideeffect() #8 [ "stream_interface"(i1* %bitstream_copy, i32 0) ]
  %output_copy = alloca i384, align 512
  call fastcc void @copy_in(%"class.hls::stream<bool, 0>"* nonnull %bitstream, i1* nonnull align 512 %bitstream_copy, %"struct.ap_uint<384>"* nonnull %output, i384* nonnull align 512 %output_copy)
  call void @apatb_sha384Accel_hw(i1* %bitstream_copy, %"struct.ap_uint<128>"* %size, i384* %output_copy)
  call void @copy_back(%"class.hls::stream<bool, 0>"* %bitstream, i1* %bitstream_copy, %"struct.ap_uint<384>"* %output, i384* %output_copy)
  ret void
}

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_in(%"class.hls::stream<bool, 0>"* noalias "unpacked"="0", i1* noalias nocapture align 512 "unpacked"="1.0", %"struct.ap_uint<384>"* noalias readonly "unpacked"="2", i384* noalias nocapture align 512 "unpacked"="3.0") unnamed_addr #2 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<bool, 0>.36"(i1* align 512 %1, %"class.hls::stream<bool, 0>"* %0)
  call fastcc void @"onebyonecpy_hls.p0struct.ap_uint<384>"(i384* align 512 %3, %"struct.ap_uint<384>"* %2)
  ret void
}
...
define internal fastcc void @"onebyonecpy_hls.p0struct.ap_uint<384>"(i384* noalias nocapture align 512 "unpacked"="0.0" %dst, %"struct.ap_uint<384>"* noalias readonly "unpacked"="1" %src) unnamed_addr #5 {
entry:
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_out(%"class.hls::stream<bool, 0>"* noalias "unpacked"="0", i1* noalias nocapture align 512 "unpacked"="1.0", %"struct.ap_uint<384>"* noalias "unpacked"="2", i384* noalias nocapture readonly align 512 "unpacked"="3.0") unnamed_addr #6 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<bool, 0>"(%"class.hls::stream<bool, 0>"* %0, i1* align 512 %1)
  call fastcc void @"onebyonecpy_hls.p0struct.ap_uint<384>.29"(%"struct.ap_uint<384>"* %2, i384* align 512 %3)
  ret void
}

; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0struct.ap_uint<384>.29"(%"struct.ap_uint<384>"* noalias "unpacked"="0" %dst, i384* noalias nocapture readonly align 512 "unpacked"="1.0" %src) unnamed_addr #5 {
entry:
...
declare void @apatb_sha384Accel_hw(i1*, %"struct.ap_uint<128>"*, i384*)

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_back(%"class.hls::stream<bool, 0>"* noalias "unpacked"="0", i1* noalias nocapture align 512 "unpacked"="1.0", %"struct.ap_uint<384>"* noalias "unpacked"="2", i384* noalias nocapture readonly align 512 "unpacked"="3.0") unnamed_addr #6 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<bool, 0>"(%"class.hls::stream<bool, 0>"* %0, i1* align 512 %1)
  call fastcc void @"onebyonecpy_hls.p0struct.ap_uint<384>.29"(%"struct.ap_uint<384>"* %2, i384* align 512 %3)
  ret void
...
declare void @sha384Accel_hw_stub(%"class.hls::stream<bool, 0>"* noalias nocapture nonnull, %"struct.ap_uint<128>"* nocapture readonly, %"struct.ap_uint<384>"* noalias nocapture nonnull)

define void @sha384Accel_hw_stub_wrapper(i1*, %"struct.ap_uint<128>"*, i384*) #7 {
entry:
  %3 = call i8* @malloc(i64 1)
  %4 = bitcast i8* %3 to %"class.hls::stream<bool, 0>"*
  %5 = call i8* @malloc(i64 64)
  %6 = bitcast i8* %5 to %"struct.ap_uint<384>"*
  call void @copy_out(%"class.hls::stream<bool, 0>"* %4, i1* %0, %"struct.ap_uint<384>"* %6, i384* %2)
  call void @sha384Accel_hw_stub(%"class.hls::stream<bool, 0>"* %4, %"struct.ap_uint<128>"* %1, %"struct.ap_uint<384>"* %6)
  call void @copy_in(%"class.hls::stream<bool, 0>"* %4, i1* %0, %"struct.ap_uint<384>"* %6, i384* %2)
  call void @free(i8* %3)
  call void @free(i8* %5)
  ret void
}
