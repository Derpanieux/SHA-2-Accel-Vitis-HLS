...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "sha384Accel.autotvin.dat"
	set constFileTvOut       "sha384Accel.autotvout.dat"
	set constFileHdlTvIn     "sha384Accel.autohdltvin.dat"
	set constFileHdlTvOut    "sha384Accel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
