...
$(ObjDir)/sha384Accel.cpp_pre.cpp.tb.o : sha384Accel.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling sha384Accel.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++14 -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/functions512.cpp_pre.cpp.tb.o : functions512.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling functions512.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++14 -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/wGenerator512.cpp_pre.cpp.tb.o : wGenerator512.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling wGenerator512.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++14 -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/chunkProcessor512.cpp_pre.cpp.tb.o : chunkProcessor512.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling chunkProcessor512.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++14 -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/chunkIter512.cpp_pre.cpp.tb.o : chunkIter512.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling chunkIter512.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++14 -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \
