...
if {[file isfile sha384Accel.autotvin.dat]} {
	file delete -force sha384Accel.autotvin.dat
}

if {[file isfile sha384Accel.autotvout.dat]} {
	file delete -force sha384Accel.autotvout.dat
}
