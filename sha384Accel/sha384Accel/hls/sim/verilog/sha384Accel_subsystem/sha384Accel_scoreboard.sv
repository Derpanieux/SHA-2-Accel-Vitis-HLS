...
//
//==============================================================
`ifndef SHA384ACCEL_SCOREBOARD__SV                                                       
    `define SHA384ACCEL_SCOREBOARD__SV                                                   
                                                                                               
    `define AUTOTB_TVOUT_output_r_output_r_wrapc  "../tv/rtldatafile/rtl.sha384Accel.autotvout_output_r.dat"
                                                                                               
    class sha384Accel_scoreboard extends uvm_component;                                        
        ...
        file_agent_pkg::file_write_agent#(384) file_wr_port_output_r_output_r;
    svr_transfer#(384) output_r_apvld_rxtr;
                                                                                               
        `uvm_component_utils_begin(sha384Accel_scoreboard)                                     
        ...
        virtual function void build_phase(uvm_phase phase);                                    
            ...
            file_wr_port_output_r_output_r = file_agent_pkg::file_write_agent#(384)::type_id::create("file_wr_port_output_r_output_r", this);
        endfunction                                                                            
        ...
        virtual task run_phase(uvm_phase phase);                                               
            ...
            if (output_r_apvld_rxtr) file_wr_port_output_r_output_r.write_TVOUT_data(output_r_apvld_rxtr.data[383: 0]);
