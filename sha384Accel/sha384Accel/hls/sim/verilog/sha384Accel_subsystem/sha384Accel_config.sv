...
//
//==============================================================
`ifndef SHA384ACCEL_CONFIG__SV                        
    `define SHA384ACCEL_CONFIG__SV                    
                                                            
    class sha384Accel_config extends uvm_object;            
        ...
        `uvm_object_utils_begin(sha384Accel_config)         
        ...
        function new (string name = "sha384Accel_config");
            super.new(name);                                
