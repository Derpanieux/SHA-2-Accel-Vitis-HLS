...
entity sha384Accel_chunkProcessor_Pipeline_VITIS_LOOP_27_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of sha384Accel_chunkProcessor_Pipeline_VITIS_LOOP_27_2 is 
...
attribute shreg_extract : string;
    ...
    component sha384Accel_chunkProcessor_Pipeline_VITIS_LOOP_27_2_kValues_ROM_AUTO_1R IS
    generic (
        DataWidth : INTEGER;
...
begin
    kValues_U : component sha384Accel_chunkProcessor_Pipeline_VITIS_LOOP_27_2_kValues_ROM_AUTO_1R
    generic map (
        DataWidth => 64,
        AddressRange => 80,
        AddressWidth => 7)
