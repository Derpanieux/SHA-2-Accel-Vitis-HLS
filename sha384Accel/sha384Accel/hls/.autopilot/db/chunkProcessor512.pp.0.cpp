# 1 "../chunkProcessor512/chunkProcessor512.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 396 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../chunkProcessor512/chunkProcessor512.cpp" 2
...
# 2 "../chunkProcessor512/chunkProcessor512.cpp" 2

void chunkProcessor(word512 input[8], word512 message[16], word512 output[8]) {

    const static word512 kValues[80] = {
    ...
    VITIS_LOOP_27_2: for(int i = 0; i < 80; i++) {
        word512 newwvars[8];
        chunkIter(kValues[i], wValues[i], wvars, newwvars);
        VITIS_LOOP_30_3: for (int j = 0; j < 8; j++) {
            wvars[j] = newwvars[j];
        }
    }
    VITIS_LOOP_34_4: for(int i = 0; i < 8; i++) {
