...
dict set ap_memory_interface_dict output_r { MEM_WIDTH 64 MEM_SIZE 64 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
...
set portList { 
	...
	{ message_q0 sc_in sc_lv 64 signal 1 } 
