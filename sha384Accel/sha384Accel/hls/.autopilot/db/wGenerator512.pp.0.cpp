# 1 "../wGenerator512/wGenerator512.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 396 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../wGenerator512/wGenerator512.cpp" 2
# 1 "../wGenerator512/wGenerator512.h" 1



# 1 "../wGenerator512/../dataTypes.h" 1
...
# 5 "../wGenerator512/wGenerator512.h" 2
# 1 "../wGenerator512/../functions512.h" 1
...
# 6 "../wGenerator512/wGenerator512.h" 2

void wGenerator(
    word512 win[16],
    word512 wout[80]
);
# 2 "../wGenerator512/wGenerator512.cpp" 2
...
void wGenerator(
    ...
    int i = 0;
    VITIS_LOOP_8_1: for(; i < 16; i++) {
        wout[i] = win[i];
    }
    VITIS_LOOP_11_2: for(; i < 80; i++) {
