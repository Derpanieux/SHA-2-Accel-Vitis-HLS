...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "sha256Accel.autotvin.dat"
	set constFileTvOut       "sha256Accel.autotvout.dat"
	set constFileHdlTvIn     "sha256Accel.autohdltvin.dat"
	set constFileHdlTvOut    "sha256Accel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
