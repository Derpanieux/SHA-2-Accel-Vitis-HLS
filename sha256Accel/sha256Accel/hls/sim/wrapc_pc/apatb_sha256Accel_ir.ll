; ModuleID = 'D:/Vitis/shaAccel/sha256Accel/sha256Accel/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_sha256Accel_ir(%"class.hls::stream<bool, 0>"* noalias nocapture nonnull dereferenceable(1) %bitstream, %"struct.ap_uint<64>"* nocapture readonly %size, %"struct.ap_uint<256>"* noalias nocapture nonnull %output) local_unnamed_addr #1 {
entry:
  ...
  call fastcc void @copy_in(%"class.hls::stream<bool, 0>"* nonnull %bitstream, i1* nonnull align 512 %bitstream_copy, %"struct.ap_uint<256>"* nonnull %output, i256* nonnull align 512 %output_copy)
  call void @apatb_sha256Accel_hw(i1* %bitstream_copy, %"struct.ap_uint<64>"* %size, i256* %output_copy)
  call void @copy_back(%"class.hls::stream<bool, 0>"* %bitstream, i1* %bitstream_copy, %"struct.ap_uint<256>"* %output, i256* %output_copy)
  ret void
}

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_in(%"class.hls::stream<bool, 0>"* noalias "unpacked"="0", i1* noalias nocapture align 512 "unpacked"="1.0", %"struct.ap_uint<256>"* noalias readonly "unpacked"="2", i256* noalias nocapture align 512 "unpacked"="3.0") unnamed_addr #2 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<bool, 0>.36"(i1* align 512 %1, %"class.hls::stream<bool, 0>"* %0)
  call fastcc void @"onebyonecpy_hls.p0struct.ap_uint<256>"(i256* align 512 %3, %"struct.ap_uint<256>"* %2)
  ret void
}
...
define internal fastcc void @"onebyonecpy_hls.p0struct.ap_uint<256>"(i256* noalias nocapture align 512 "unpacked"="0.0" %dst, %"struct.ap_uint<256>"* noalias readonly "unpacked"="1" %src) unnamed_addr #5 {
entry:
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_out(%"class.hls::stream<bool, 0>"* noalias "unpacked"="0", i1* noalias nocapture align 512 "unpacked"="1.0", %"struct.ap_uint<256>"* noalias "unpacked"="2", i256* noalias nocapture readonly align 512 "unpacked"="3.0") unnamed_addr #6 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<bool, 0>"(%"class.hls::stream<bool, 0>"* %0, i1* align 512 %1)
  call fastcc void @"onebyonecpy_hls.p0struct.ap_uint<256>.29"(%"struct.ap_uint<256>"* %2, i256* align 512 %3)
  ret void
}

; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0struct.ap_uint<256>.29"(%"struct.ap_uint<256>"* noalias "unpacked"="0" %dst, i256* noalias nocapture readonly align 512 "unpacked"="1.0" %src) unnamed_addr #5 {
entry:
...
declare void @apatb_sha256Accel_hw(i1*, %"struct.ap_uint<64>"*, i256*)

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_back(%"class.hls::stream<bool, 0>"* noalias "unpacked"="0", i1* noalias nocapture align 512 "unpacked"="1.0", %"struct.ap_uint<256>"* noalias "unpacked"="2", i256* noalias nocapture readonly align 512 "unpacked"="3.0") unnamed_addr #6 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<bool, 0>"(%"class.hls::stream<bool, 0>"* %0, i1* align 512 %1)
  call fastcc void @"onebyonecpy_hls.p0struct.ap_uint<256>.29"(%"struct.ap_uint<256>"* %2, i256* align 512 %3)
  ret void
...
declare void @sha256Accel_hw_stub(%"class.hls::stream<bool, 0>"* noalias nocapture nonnull, %"struct.ap_uint<64>"* nocapture readonly, %"struct.ap_uint<256>"* noalias nocapture nonnull)

define void @sha256Accel_hw_stub_wrapper(i1*, %"struct.ap_uint<64>"*, i256*) #7 {
entry:
  ...
  call void @copy_out(%"class.hls::stream<bool, 0>"* %4, i1* %0, %"struct.ap_uint<256>"* %6, i256* %2)
  call void @sha256Accel_hw_stub(%"class.hls::stream<bool, 0>"* %4, %"struct.ap_uint<64>"* %1, %"struct.ap_uint<256>"* %6)
  call void @copy_in(%"class.hls::stream<bool, 0>"* %4, i1* %0, %"struct.ap_uint<256>"* %6, i256* %2)
  call void @free(i8* %3)
  call void @free(i8* %5)
  ret void
}
