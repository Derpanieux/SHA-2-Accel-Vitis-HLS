...
if {[file isfile sha256Accel.autotvin.dat]} {
	file delete -force sha256Accel.autotvin.dat
}

if {[file isfile sha256Accel.autotvout.dat]} {
	file delete -force sha256Accel.autotvout.dat
}
