...
//
//==============================================================
`ifndef SHA256ACCEL_CONFIG__SV                        
    `define SHA256ACCEL_CONFIG__SV                    
                                                            
    class sha256Accel_config extends uvm_object;            
        ...
        `uvm_object_utils_begin(sha256Accel_config)         
        ...
        function new (string name = "sha256Accel_config");
            super.new(name);                                
