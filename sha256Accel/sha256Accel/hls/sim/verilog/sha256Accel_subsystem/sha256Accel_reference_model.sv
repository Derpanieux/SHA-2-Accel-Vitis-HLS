...
`ifndef SHA256ACCEL_REFERENCE_MODEL_SV
`define SHA256ACCEL_REFERENCE_MODEL_SV

class sha256Accel_reference_model extends uvm_component;
    ...
    `uvm_component_utils_begin(sha256Accel_reference_model)
