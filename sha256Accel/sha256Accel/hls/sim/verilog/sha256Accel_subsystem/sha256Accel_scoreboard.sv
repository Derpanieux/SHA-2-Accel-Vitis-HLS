...
//
//==============================================================
`ifndef SHA256ACCEL_SCOREBOARD__SV                                                       
    `define SHA256ACCEL_SCOREBOARD__SV                                                   
                                                                                               
    `define AUTOTB_TVOUT_output_r_output_r_wrapc  "../tv/rtldatafile/rtl.sha256Accel.autotvout_output_r.dat"
                                                                                               
    class sha256Accel_scoreboard extends uvm_component;                                        
        ...
        file_agent_pkg::file_write_agent#(256) file_wr_port_output_r_output_r;
    svr_transfer#(256) output_r_apvld_rxtr;
                                                                                               
        `uvm_component_utils_begin(sha256Accel_scoreboard)                                     
        ...
        virtual function void build_phase(uvm_phase phase);                                    
            ...
            file_wr_port_output_r_output_r = file_agent_pkg::file_write_agent#(256)::type_id::create("file_wr_port_output_r_output_r", this);
        endfunction                                                                            
        ...
        virtual task run_phase(uvm_phase phase);                                               
            ...
            if (output_r_apvld_rxtr) file_wr_port_output_r_output_r.write_TVOUT_data(output_r_apvld_rxtr.data[255: 0]);
