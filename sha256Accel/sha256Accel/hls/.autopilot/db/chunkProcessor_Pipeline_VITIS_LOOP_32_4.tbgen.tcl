set moduleName chunkProcessor_Pipeline_VITIS_LOOP_32_4
set isTopModule 0
...
set cdfgNum 14
set C_modelName {chunkProcessor_Pipeline_VITIS_LOOP_32_4}
...
dict set ap_memory_interface_dict wvars { MEM_WIDTH 32 MEM_SIZE 32 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict output_r { MEM_WIDTH 32 MEM_SIZE 32 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ input_r int 32 regular {array 8 { 1 3 } 1 1 }  }
	{ wvars int 32 regular {array 8 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "input_r", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "wvars", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ wvars_q0 sc_in sc_lv 32 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "wvars_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "wvars", "role": "q0" }} , 
...
set Spec2ImplPortList { 
	...
	wvars { ap_memory {  { wvars_address0 mem_address 1 3 }  { wvars_ce0 mem_ce 1 1 }  { wvars_q0 mem_dout 0 32 } } }
