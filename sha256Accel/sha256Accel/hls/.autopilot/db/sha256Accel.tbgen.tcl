...
set cdfgNum 14
set C_modelName {sha256Accel}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ bitstream int 1 regular {fifo 0 volatile }  }
	{ size int 64 regular  }
	{ output_r int 256 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "bitstream", "interface" : "fifo", "bitwidth" : 1, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "output_r", "interface" : "wire", "bitwidth" : 256, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ output_r sc_out sc_lv 256 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "output_r", "direction": "out", "datatype": "sc_lv", "bitwidth":256, "type": "signal", "bundle":{"name": "output_r", "role": "default" }} , 
...
set ArgLastReadFirstWriteLatency {
	...
	sha256Accel_Pipeline_VITIS_LOOP_35_4 {
		...
		size {Type I LastRead 0 FirstWrite -1}}
	sha256Accel_Pipeline_VITIS_LOOP_43_5 {
...
set Spec2ImplPortList { 
	...
	output_r { ap_vld {  { output_r out_data 1 256 }  { output_r_ap_vld out_vld 1 1 } } }
}
