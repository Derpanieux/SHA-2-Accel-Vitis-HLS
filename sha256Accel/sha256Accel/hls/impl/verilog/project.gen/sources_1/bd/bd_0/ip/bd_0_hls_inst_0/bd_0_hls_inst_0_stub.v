...
//               d:/Vitis/shaAccel/sha256Accel/sha256Accel/hls/impl/verilog/project.gen/sources_1/bd/bd_0/ip/bd_0_hls_inst_0/bd_0_hls_inst_0_stub.v
...
(* CHECK_LICENSE_TYPE = "bd_0_hls_inst_0,sha256Accel,{}" *) (* CORE_GENERATION_INFO = "bd_0_hls_inst_0,sha256Accel,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=hls,x_ipName=sha256Accel,x_ipVersion=1.0,x_ipCoreRevision=2114182639,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "HLS" *) (* X_CORE_INFO = "sha256Accel,Vivado 2025.1" *) (* hls_module = "yes" *) 
module bd_0_hls_inst_0(output_r_ap_vld, ap_clk, ap_rst, ap_done, 
  ap_idle, ap_ready, ap_start, bitstream_dout, bitstream_empty_n, bitstream_read, size, output_r)
/* synthesis syn_black_box black_box_pad_pin="output_r_ap_vld,ap_rst,ap_done,ap_idle,ap_ready,ap_start,bitstream_dout,bitstream_empty_n,bitstream_read,size[63:0],output_r[255:0]" */
