...
module sha256Accel_chunkProcessor_Pipeline_VITIS_LOOP_25_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        add_i26_i241347_out,
        add_i26_i241347_out_ap_vld,
        thr_add56256_out,
        thr_add56256_out_ap_vld,
        thr_add5625_out,
        thr_add5625_out_ap_vld,
        add_i26_i24134_out,
        add_i26_i24134_out_ap_vld,
        add_i26_i2413_out,
        add_i26_i2413_out_ap_vld,
        thr_add562_out,
        thr_add562_out_ap_vld,
        add_i26_i241_out,
        add_i26_i241_out_ap_vld
);
...
output  [31:0] add_i26_i241347_out;
output   add_i26_i241347_out_ap_vld;
output  [31:0] thr_add56256_out;
output   thr_add56256_out_ap_vld;
output  [31:0] thr_add5625_out;
output   thr_add5625_out_ap_vld;
output  [31:0] add_i26_i24134_out;
output   add_i26_i24134_out_ap_vld;
output  [31:0] add_i26_i2413_out;
output   add_i26_i2413_out_ap_vld;
output  [31:0] thr_add562_out;
output   thr_add562_out_ap_vld;
output  [31:0] add_i26_i241_out;
output   add_i26_i241_out_ap_vld;

reg ap_idle;
reg thr_add562568_out_ap_vld;
reg add_i26_i241347_out_ap_vld;
reg thr_add56256_out_ap_vld;
reg thr_add5625_out_ap_vld;
reg add_i26_i24134_out_ap_vld;
reg add_i26_i2413_out_ap_vld;
reg thr_add562_out_ap_vld;
reg add_i26_i241_out_ap_vld;
...
reg   [31:0] add_i26_i241347_fu_120;
reg   [31:0] thr_add562568_fu_124;
reg   [31:0] add_i26_i241_fu_128;
wire   [31:0] add_ln19_fu_613_p2;
reg   [31:0] add_i26_i24134_fu_132;
...
#0 i_fu_104 = 7'd0;
#0 add_i26_i2413_fu_108 = 32'd0;
#0 thr_add5625_fu_112 = 32'd0;
#0 thr_add562_fu_116 = 32'd0;
#0 add_i26_i241347_fu_120 = 32'd0;
#0 thr_add562568_fu_124 = 32'd0;
#0 add_i26_i241_fu_128 = 32'd0;
#0 add_i26_i24134_fu_132 = 32'd0;
#0 thr_add56256_fu_136 = 32'd0;
#0 ap_done_reg = 1'b0;
end

sha256Accel_chunkProcessor_Pipeline_VITIS_LOOP_25_2_kValues_ROM_AUTO_1R #(
    .DataWidth( 32 ),
    .AddressRange( 64 ),
    .AddressWidth( 6 ))
kValues_U(
...
always @ (*) begin
    if (((icmp_ln25_reg_724 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_exit_ready_pp0_iter1_reg == 1'b1))) begin
        add_i26_i241347_out_ap_vld = 1'b1;
    end else begin
        add_i26_i241347_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln25_reg_724 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_exit_ready_pp0_iter1_reg == 1'b1))) begin
        add_i26_i24134_out_ap_vld = 1'b1;
    end else begin
        add_i26_i24134_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln25_reg_724 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_exit_ready_pp0_iter1_reg == 1'b1))) begin
        add_i26_i2413_out_ap_vld = 1'b1;
    end else begin
        add_i26_i2413_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln25_reg_724 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_exit_ready_pp0_iter1_reg == 1'b1))) begin
        add_i26_i241_out_ap_vld = 1'b1;
    end else begin
        add_i26_i241_out_ap_vld = 1'b0;
    end
end
...
assign add_i26_i241347_out = add_i26_i241347_fu_120;

assign add_i26_i24134_out = add_i26_i24134_fu_132;

assign add_i26_i2413_out = add_i26_i2413_fu_108;

assign add_i26_i241_out = add_i26_i241_fu_128;

assign add_ln13_1_fu_471_p2 = (add_ln13_reg_738 + add_i26_i241347_fu_120);
...
assign and_ln13_1_fu_423_p2 = (add_i26_i241_fu_128 & add_i26_i2413_fu_108);

assign and_ln13_fu_417_p2 = (xor_ln13_fu_411_p2 & add_i26_i24134_fu_132);
...
assign lshr_ln5_fu_369_p4 = {{add_i26_i241_fu_128[31:6]}};

assign lshr_ln6_fu_383_p4 = {{add_i26_i241_fu_128[31:11]}};
...
assign lshr_ln_fu_397_p4 = {{add_i26_i241_fu_128[31:25]}};

assign or_ln13_1_fu_437_p3 = {{trunc_ln18_fu_393_p1}, {lshr_ln6_fu_383_p4}};

assign or_ln13_3_fu_451_p3 = {{trunc_ln19_fu_407_p1}, {lshr_ln_fu_397_p4}};
...
assign or_ln2_fu_429_p3 = {{trunc_ln17_fu_379_p1}, {lshr_ln5_fu_369_p4}};
...
assign trunc_ln17_fu_379_p1 = add_i26_i241_fu_128[5:0];

assign trunc_ln18_fu_393_p1 = add_i26_i241_fu_128[10:0];

assign trunc_ln19_fu_407_p1 = add_i26_i241_fu_128[24:0];
...
assign xor_ln13_2_fu_465_p2 = (xor_ln13_1_fu_459_p2 ^ or_ln2_fu_429_p3);

assign xor_ln13_fu_411_p2 = (32'd4294967295 ^ add_i26_i241_fu_128);
...
endmodule //sha256Accel_chunkProcessor_Pipeline_VITIS_LOOP_25_2
