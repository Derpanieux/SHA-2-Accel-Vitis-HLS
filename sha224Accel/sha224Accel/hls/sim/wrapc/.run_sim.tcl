...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "sha224Accel.autotvin.dat"
	set constFileTvOut       "sha224Accel.autotvout.dat"
	set constFileHdlTvIn     "sha224Accel.autohdltvin.dat"
	set constFileHdlTvOut    "sha224Accel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
