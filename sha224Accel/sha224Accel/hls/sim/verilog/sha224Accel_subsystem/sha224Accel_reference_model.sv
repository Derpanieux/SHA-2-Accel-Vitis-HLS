...
`ifndef SHA224ACCEL_REFERENCE_MODEL_SV
`define SHA224ACCEL_REFERENCE_MODEL_SV

class sha224Accel_reference_model extends uvm_component;
    ...
    `uvm_component_utils_begin(sha224Accel_reference_model)
