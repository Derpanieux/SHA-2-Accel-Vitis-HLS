...
if {[file isfile sha224Accel.autotvin.dat]} {
	file delete -force sha224Accel.autotvin.dat
}

if {[file isfile sha224Accel.autotvout.dat]} {
	file delete -force sha224Accel.autotvout.dat
}
