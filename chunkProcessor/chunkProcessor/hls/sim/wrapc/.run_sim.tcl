...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "chunkProcessor.autotvin.dat"
	set constFileTvOut       "chunkProcessor.autotvout.dat"
	set constFileHdlTvIn     "chunkProcessor.autohdltvin.dat"
	set constFileHdlTvOut    "chunkProcessor.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
