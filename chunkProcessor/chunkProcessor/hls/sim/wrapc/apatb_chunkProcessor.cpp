...
#define AUTOTB_TVOUT_input_r "../tv/cdatafile/c.chunkProcessor.autotvout_input_r.dat"
#define AUTOTB_TVIN_message "../tv/cdatafile/c.chunkProcessor.autotvin_message.dat"
#define AUTOTB_TVOUT_message "../tv/cdatafile/c.chunkProcessor.autotvout_message.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_output_r "../tv/rtldatafile/rtl.chunkProcessor.autotvout_output_r.dat"
...
extern "C"
void chunkProcessor_hw_stub_wrapper(void*, void*, void*);

extern "C"
void apatb_chunkProcessor_hw(void* __xlx_apatb_param_input_r, void* __xlx_apatb_param_message, void* __xlx_apatb_param_output_r)
{
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port1 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_message),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_message),
#endif
#endif
    .hasWrite = { false },
    .max_nbytes = { 0 },
  };
  port1.param = { __xlx_apatb_param_message };
  port1.mname = { "message" };
  port1.nbytes = { 64 };
  ...
  try {
    ...
    chunkProcessor_hw_stub_wrapper(__xlx_apatb_param_input_r, __xlx_apatb_param_message, __xlx_apatb_param_output_r);
