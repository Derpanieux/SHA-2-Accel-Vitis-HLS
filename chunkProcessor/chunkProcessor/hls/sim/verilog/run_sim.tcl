...
if {[file isfile chunkProcessor.autotvin.dat]} {
	file delete -force chunkProcessor.autotvin.dat
}

if {[file isfile chunkProcessor.autotvout.dat]} {
	file delete -force chunkProcessor.autotvout.dat
}
