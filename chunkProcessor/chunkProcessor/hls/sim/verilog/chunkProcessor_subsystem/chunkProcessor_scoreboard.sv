...
//
//==============================================================
`ifndef CHUNKPROCESSOR_SCOREBOARD__SV                                                       
    `define CHUNKPROCESSOR_SCOREBOARD__SV                                                   
                                                                                               
                                                                                               
    class chunkProcessor_scoreboard extends uvm_component;                                        
                                                                                               
        chunkProcessor_reference_model refm;                                                      
                                                                                               
                                                                                               
        `uvm_component_utils_begin(chunkProcessor_scoreboard)                                     
