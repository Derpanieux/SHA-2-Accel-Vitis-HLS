...
`ifndef CHUNKPROCESSOR_REFERENCE_MODEL_SV
`define CHUNKPROCESSOR_REFERENCE_MODEL_SV

class chunkProcessor_reference_model extends uvm_component;
    int trans_num_total = 5000;
    int trans_num_idx;
    int ap_done_cnt=1;
    ...
    `uvm_component_utils_begin(chunkProcessor_reference_model)
