...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.chunkProcessor.autotvin_input_r.dat"
         "c.chunkProcessor.autotvin_message.dat"
         "c.chunkProcessor.autotvin_output_r.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.chunkProcessor.autotvout_output_r.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
