...
# 2 "<built-in>" 2
# 1 "chunkProcessor.cpp" 2
# 1 "./chunkProcessor.h" 1



# 1 "./../wGenerator/wGenerator.h" 1



# 1 "./../wGenerator/../dataTypes.h" 1
...
# 5 "./../wGenerator/wGenerator.h" 2
# 1 "./../wGenerator/../functions256.h" 1
...
# 6 "./../wGenerator/wGenerator.h" 2

void wGenerator(
    word256 win[16],
    word256 wout[64]
);
# 5 "./chunkProcessor.h" 2
# 1 "./../chunkIteration/chunkIter.h" 1
...
# 6 "./chunkProcessor.h" 2

__attribute__((sdx_kernel("chunkProcessor", 0))) void chunkProcessor(word256 input[8], word256 message[16], word256 output[8]);
# 2 "chunkProcessor.cpp" 2

__attribute__((sdx_kernel("chunkProcessor", 0))) void chunkProcessor(word256 input[8], word256 message[16], word256 output[8]) {
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=chunkProcessor
# 3 "chunkProcessor.cpp"
