...
using hls::sim::Byte;
extern "C" void chunkProcessor(Byte<4>*, Byte<4>*, Byte<4>*);
extern "C" void apatb_chunkProcessor_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_message, volatile void * __xlx_apatb_param_output_r) {
...
__xlx_input_r__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_input_r)[i]);
  ...
  // Collect __xlx_message__tmp_vec
std::vector<Byte<4>> __xlx_message__tmp_vec;
for (size_t i = 0; i < 16; ++i){
__xlx_message__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_message)[i]);
}
  int __xlx_size_param_message = 16;
...
__xlx_output_r__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_output_r)[i]);
  ...
  // DUT call
  chunkProcessor(__xlx_input_r__tmp_vec.data(), __xlx_message__tmp_vec.data(), __xlx_output_r__tmp_vec.data());
...
for (size_t i = 0; i < __xlx_size_param_message; ++i) {
((Byte<4>*)__xlx_apatb_param_message)[i] = __xlx_message__tmp_vec[__xlx_offset_param_message+i];
}
