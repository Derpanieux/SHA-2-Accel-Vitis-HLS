...
entity chunkProcessor_chunkProcessor_Pipeline_VITIS_LOOP_25_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of chunkProcessor_chunkProcessor_Pipeline_VITIS_LOOP_25_2 is 
...
attribute shreg_extract : string;
    ...
    signal add_i26_i2313_fu_108 : STD_LOGIC_VECTOR (31 downto 0) := "00000000000000000000000000000000";
    ...
    signal add_i26_i231347_fu_120 : STD_LOGIC_VECTOR (31 downto 0) := "00000000000000000000000000000000";
    signal thr_add562568_fu_124 : STD_LOGIC_VECTOR (31 downto 0) := "00000000000000000000000000000000";
    signal add_i26_i231_fu_128 : STD_LOGIC_VECTOR (31 downto 0) := "00000000000000000000000000000000";
    signal add_ln19_fu_613_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_i26_i23134_fu_132 : STD_LOGIC_VECTOR (31 downto 0) := "00000000000000000000000000000000";
    ...
    signal lshr_ln4_fu_369_p4 : STD_LOGIC_VECTOR (25 downto 0);
    signal trunc_ln18_fu_393_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal lshr_ln5_fu_383_p4 : STD_LOGIC_VECTOR (20 downto 0);
    ...
    signal lshr_ln6_fu_397_p4 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal or_ln1_fu_429_p3 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    component chunkProcessor_chunkProcessor_Pipeline_VITIS_LOOP_25_2_kValues_ROM_AUTO_1R IS
    generic (
        DataWidth : INTEGER;
    ...
    component chunkProcessor_flow_control_loop_pipe_sequential_init IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    kValues_U : component chunkProcessor_chunkProcessor_Pipeline_VITIS_LOOP_25_2_kValues_ROM_AUTO_1R
    generic map (
        DataWidth => 32,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    flow_control_loop_pipe_sequential_init_U : component chunkProcessor_flow_control_loop_pipe_sequential_init
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => ap_start,
    ...
    add_i26_i231347_fu_120_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
    ...
    add_i26_i23134_fu_132_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
    ...
    add_i26_i2313_fu_108_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
    ...
    add_i26_i231_fu_128_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
    ...
    add_i26_i231347_out <= add_i26_i231347_fu_120;

    add_i26_i231347_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln25_reg_724, ap_block_pp0_stage0_11001, ap_loop_exit_ready_pp0_iter1_reg)
    begin
        if (((icmp_ln25_reg_724 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_exit_ready_pp0_iter1_reg = ap_const_logic_1))) then 
            add_i26_i231347_out_ap_vld <= ap_const_logic_1;
        else 
            add_i26_i231347_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    add_i26_i23134_out <= add_i26_i23134_fu_132;

    add_i26_i23134_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln25_reg_724, ap_block_pp0_stage0_11001, ap_loop_exit_ready_pp0_iter1_reg)
    begin
        if (((icmp_ln25_reg_724 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_exit_ready_pp0_iter1_reg = ap_const_logic_1))) then 
            add_i26_i23134_out_ap_vld <= ap_const_logic_1;
        else 
            add_i26_i23134_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    add_i26_i2313_out <= add_i26_i2313_fu_108;

    add_i26_i2313_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln25_reg_724, ap_block_pp0_stage0_11001, ap_loop_exit_ready_pp0_iter1_reg)
    begin
        if (((icmp_ln25_reg_724 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_exit_ready_pp0_iter1_reg = ap_const_logic_1))) then 
            add_i26_i2313_out_ap_vld <= ap_const_logic_1;
        else 
            add_i26_i2313_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    add_i26_i231_out <= add_i26_i231_fu_128;

    add_i26_i231_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln25_reg_724, ap_block_pp0_stage0_11001, ap_loop_exit_ready_pp0_iter1_reg)
    begin
        if (((icmp_ln25_reg_724 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_exit_ready_pp0_iter1_reg = ap_const_logic_1))) then 
            add_i26_i231_out_ap_vld <= ap_const_logic_1;
        else 
            add_i26_i231_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    add_ln13_1_fu_471_p2 <= std_logic_vector(unsigned(add_ln13_reg_738) + unsigned(add_i26_i231347_fu_120));
    ...
    and_ln13_1_fu_423_p2 <= (add_i26_i231_fu_128 and add_i26_i2313_fu_108);
    and_ln13_fu_417_p2 <= (xor_ln13_fu_411_p2 and add_i26_i23134_fu_132);
    ...
    lshr_ln4_fu_369_p4 <= add_i26_i231_fu_128(31 downto 6);
    lshr_ln5_fu_383_p4 <= add_i26_i231_fu_128(31 downto 11);
    lshr_ln6_fu_397_p4 <= add_i26_i231_fu_128(31 downto 25);
    ...
    or_ln13_1_fu_437_p3 <= (trunc_ln18_fu_393_p1 & lshr_ln5_fu_383_p4);
    or_ln13_3_fu_451_p3 <= (trunc_ln19_fu_407_p1 & lshr_ln6_fu_397_p4);
    ...
    or_ln1_fu_429_p3 <= (trunc_ln17_fu_379_p1 & lshr_ln4_fu_369_p4);
    ...
    trunc_ln17_fu_379_p1 <= add_i26_i231_fu_128(6 - 1 downto 0);
    trunc_ln18_fu_393_p1 <= add_i26_i231_fu_128(11 - 1 downto 0);
    trunc_ln19_fu_407_p1 <= add_i26_i231_fu_128(25 - 1 downto 0);
    ...
    xor_ln13_2_fu_465_p2 <= (xor_ln13_1_fu_459_p2 xor or_ln1_fu_429_p3);
    xor_ln13_fu_411_p2 <= (ap_const_lv32_FFFFFFFF xor add_i26_i231_fu_128);
